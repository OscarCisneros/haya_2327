#Simulación de conversión a monte irregular según las recomendaciones de la ordenación de Aralar
...
# Escenario
  ...
  escenario.nombre <- "Aralar_A"
  grupo <- "aralar" #"go_fagus" "selv_macizo_pirenaico"
  # densidad inicial
  N_ini = 700
  # área basimétrica inicial
  G_ini = 26
  # calidad de estación
  IS = 22
  # rango de edades
