...
#inicio_monte_regular_aralar <- read.csv2("~/R_proyectos/2327/datos/escenarios/aralar/inicio_monte_regular_aralar.csv")
inicio_monte_regular_aralar <- read.csv2("~/R_proyectos/2327/datos/escenarios/aralar/corto_inicio_monte_regular_aralar.csv") # sólo 6 escenarios
...
IS_ = c(13,19,25) #c(13,16,19,22,25)

#área basimétrica objetivo
ab_objetivo_ = c(15,20,25)
precis_ab = 0.05 #margen para el ab_objetivo

#rango de diámetros
diam_max_ = seq(60.5,100.5, by =10) #seq(60.5,100.5, by =5)
diam_min = 7.5
