...
#Ecuaciones de Madrigal a partir de 20 años, antes las de GOFagus
...
funcion_genera_escenarios_vol_min_Madrigal <- function(grupo_ = "PC_madrigal", escenario.nombre_ = "PC1_madrigal_IS25_alta",
                                      N_ini_ = 8000) {
