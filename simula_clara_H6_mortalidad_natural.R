...
# Escenario
      ...
      escenario.nombre <- "H6_SFA_Charrus"
      
      #esquema de tratamientos
      escenario.tratamiento <- read.delim("datos/escenarios/go_fagus/tratamientos_No_gestion_240.csv")
...
# Parámetros de inicio
      ...
      mort_interc <- 12.950  #13.046138
      mort_pend <- -1.941 #-1.90102
...
# 5. Calcular los parámetros de "Extraido en la clara", "Después de la clara", "Crecimiento"
      ...
      func_trat <- function(tratam_ = "clareo", i_ = 2) {
       if (tratam_ == "") {
         ...
         } else if (tratam_ %in% c("clara por lo bajo","clara mixta","diseminatoria","aclaratoria 1", "aclaratoria")) {
