#función para generar los escenarios en xls para CO2Fix y obenter la suma de Crecimiento corriente anual como indicador de calidad del escenario
#Simulación de clara
...
funcion_genera_escenarios_<- function(grupo_ = "go_fagus", escenario.nombre_ = "H5_IS19_alta",
                                      N_ini_ = 7000) {
